			...
			<div class="row section-content">
				<div class="section-title text-center">
					...
					<div class="section-title-text">
						<h2>The CaringHeart Foundation was established in June 2022 to address accessibility to quality and affordable educational and health infrastructure for the African Child...</h2>
					</div>
				</div>
				<!-- /section-title -->
							...
							<div class="latest-news-slide-content">
								<div class="latest-news-slide text-center">
									...
									<div class="slide-text pb60">
										<p>WE all can make the world a better place...
										</p>
									</div>
									<!-- /slide-text -->
									<div class="quate-client-pic-text">
										...
										<div class="quate-client-text pb30">
											<span class="client-name">Femi S. Folayan</span>
											<span class="designation">FOUNDER, The CaringHeart Foundation</span>
										</div>
									</div>
								...
								<div class="latest-news-slide text-center">
									...
									<div class="quate-client-pic-text">
										...
										<div class="quate-client-text pb30">
											<span class="client-name">Abimbola C. Folayan</span>
											<span class="designation">CO-FOUNDER, The CaringHeart Foundation</span>
										</div>
									</div>
